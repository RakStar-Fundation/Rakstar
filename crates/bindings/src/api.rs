...
pub unsafe fn initialize_capi(api: *mut OmpApi) -> bool {
    ...
    load_fn!(
        ...
        "Player_GetPlayerAmmo"
    );
    load_fn!(lib, api, (*api).player.set_ammo, "Player_SetAmmo");
    load_fn!(
        lib,
        api,
    ...
    load_fn!(
        ...
        "Player_GetWeaponData"
    );
    load_fn!(
        lib,
        api,
        (*api).player.get_weapon_state,
        "Player_GetWeaponState"
    );
    load_fn!(lib, api, (*api).player.get_keys, "Player_GetKeys");
    load_fn!(
        lib,
        api,
        (*api).player.get_camera_mode,
        "Player_GetCameraMode"
    );
    load_fn!(
        lib,
        api,
    ...
    load_fn!(
        ...
        "Player_GetCameraAspectRatio"
    );
    load_fn!(
        lib,
        api,
        (*api).player.get_camera_front_vector,
        "Player_GetCameraFrontVector"
    );
    load_fn!(
        lib,
        api,
    ...
    load_fn!(
        ...
        "Player_SetFightingStyle"
    );
    load_fn!(
        lib,
        api,
        (*api).player.force_class_selection,
        "Player_ForceClassSelection"
    );
    load_fn!(
        lib,
        api,
        (*api).player.allow_teleport,
        "Player_AllowTeleport"
    );
    load_fn!(
        lib,
        api,
    ...
    load_fn!(lib, api, (*api).player.allow_weapons, "Player_AllowWeapons");
    load_fn!(
        lib,
        api,
    ...
    load_fn!(lib, api, (*api).player.toggle_clock, "Player_ToggleClock");
    load_fn!(lib, api, (*api).player.has_clock, "Player_HasClock");
